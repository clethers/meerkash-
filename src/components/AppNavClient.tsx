...
export function AppNavClient({ groups, unread }: { groups: Group[]; unread: number }) {
  return (
    <nav className="relative mx-auto flex h-16 max-w-4xl items-center justify-between px-4">
      ...
      <div className="flex items-center">
        ...
        <Link
          ...
          className={[
            'relative flex h-11 w-11 items-center justify-center rounded-full text-slate-600',
